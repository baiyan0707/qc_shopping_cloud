...
public class ExceptionCatch {
    ...
    public ResponseResult customException(CustomException customException) {
        logger.error("catch framework : {}", customException.getMessage());
        //捕获到错误代码
    ...
    public ResponseResult exception(Exception exception) {
        ...
        logger.error("catch framework : {}", exception.getMessage());
        ...
        if (resultCode != null) {
            ...
            //返回99999异常
            return new ResponseResult(GoodsCode.SERVER_ERROR);
        }
    }

    static {
        //定义异常类型所对应的错误代码
        builder.put(HttpMessageNotReadableException.class, GoodsCode.INVALID_PARAM);
    }
}
